local Translations = {
    ...
    general = {
        ...
        item_authorization_menu = "Item Autorsatie",
        citizenid_authorization_menu = "CitizenID Autorisatie",
        gang_authorization_menu = "Gang Autorisatie",
        job_authorization_menu = "Baan Autorisatie",
        ...
        warn_no_authorization = "%{player} (%{license}) probeerde een deur te openen zonder autorisatie (Stuurde: %{doorID})",
