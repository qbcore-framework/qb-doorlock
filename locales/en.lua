local Translations = {
    ...
    general = {
        job_grade_authorization_menu = "Job Grade (Req for Job, Type & Gang)",
        job_type_authorization_menu = "Job Type Authorization",
        locked = "Locked",
        unlocked = "Unlocked",
        ...
        item_authorization_menu = "Item Authorzation",
        citizenid_authorization_menu = "CitizenID authorization",
        gang_authorization_menu = "Gang authorization",
        job_authorization_menu = "Job Authorization",
        ...
        warn_no_authorization = "%{player} (%{license}) attempted to open a door without authorization (Sent: %{doorID})",
