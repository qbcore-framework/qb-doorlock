local Translations = {
    ...
    general = {
        ...
        item_authorization_menu = "عنصر مسموح",
        citizenid_authorization_menu = "تصريح المواطن",
        gang_authorization_menu = "العصابة",
        job_authorization_menu = "الوظيفة",
        ...
        warn_no_authorization = "%{player} (%{license}) حاولت فتح باب بدون إذن (أرسلت: %{doorID})",
