local Translations = {
    ...
    general = {
        ...
        item_authorization_menu = "Autorisation Objet",
        citizenid_authorization_menu = "Autorisation CitizenID",
        gang_authorization_menu = "Autorisation Gang",
        job_authorization_menu = "Autorisation Job",
        ...
        warn_no_authorization = "%{player} (%{license}) à essayé d'ouvrir une porte sans autorisation (Sent: %{doorID})",
