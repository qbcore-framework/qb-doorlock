local Translations = {
    ...
    general = {
        ...
        item_authorization_menu = "Autorização com item",
        citizenid_authorization_menu = "CitizenID autorizado",
        gang_authorization_menu = "Gang autorizado",
        job_authorization_menu = "Trabalho autorizado",
        ...
        warn_no_authorization = "%{player} (%{license}) tentou abrir uma porta sem autorização (Sent: %{doorID})",
