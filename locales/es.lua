local Translations = {
    ...
    general = {
        ...
        item_authorization_menu = "Autorización de objeto",
        citizenid_authorization_menu = "Autorización de CitizenID",
        gang_authorization_menu = "Autorización de banda",
        job_authorization_menu = "Autorización de trabajo",
        ...
        warn_no_authorization = "%{player} (%{license}) trató de abrir una puerta sin autorización (Enviado: %{doorID})",
